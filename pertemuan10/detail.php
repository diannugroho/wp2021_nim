...
// $mahasiswa = query("SELECT * FROM calon_mhs ");
// ambil id dari praktik2
$id = $_GET['id'];
$mahasiswa = query("SELECT * FROM calon_mhs WHERE id =$id");
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 p-5 pt-5">
      ...
      <ul>
        ...
        <li>agama : <?= $mahasiswa['agama']; ?></li>
        <li>asal sekolah : <?= $mahasiswa['sekolah_asal']; ?></li>
        <li><img src="image/<?= $mahasiswa['foto_maba']; ?>" alt=""></li>
        <li><a href="">ubah data</a> || <a href="">hapus data</a> </li>
        <li><a href="praktik2.php">kembali</a></li>
      </ul>
